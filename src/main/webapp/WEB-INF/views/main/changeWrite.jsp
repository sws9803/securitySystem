...
<script type="text/javascript">
	...
	function noticeSave() {
		...
		var url = "notice/updateNoticeInfo.do";
...
<!-- checkbox 공지 수정시 체크박스가 체크가 되어있도록함. -->
<%
	...
	<article>
		...
		<div class="container" role="main">
			...
			<form name="form" id="form" role="form" method="post"
				...
				<div id="box1">
					<input class="form-check-input" type="checkbox" <%if(type.equals("T")){%> checked<%}%>
